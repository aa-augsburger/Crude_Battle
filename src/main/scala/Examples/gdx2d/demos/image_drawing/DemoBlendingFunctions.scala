package Examples.gdx2d.demos.image_drawing
 ...
 * @version 2.0
 */
class DemoBlendingFunctions extends PortableApplication {
...
object DemoBlendingFunctions {
  def main(args: Array[String]): Unit = new DemoBlendingFunctions()
}
