package Examples.gdx2d.demos.physics.mouse_interaction
 ...
 * @version 2.0
 */
class DemoPhysicsMouse(wWidth: Int, wHeight: Int) extends PortableApplication(wWidth, wHeight) {
